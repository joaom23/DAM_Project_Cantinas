...
namespace App_DAM.Droid
{
    ...
    public class CustomMapRenderer : MapRenderer, GoogleMap.IInfoWindowAdapter
    {
        ...
        protected override MarkerOptions CreateMarker(Pin pin)
        {
            ...
            else if(p.Name == "Cantina")
            {
                //Icon das cantinas
                marker.SetIcon(BitmapDescriptorFactory.FromResource(Resource.Drawable.cantinaPin));
            }
        ...
        async void OnInfoWindowClick(object sender, GoogleMap.InfoWindowClickEventArgs e)
        {
            ...
            if(customPin.Name == "Cantina")
            {
                await App.Current.MainPage.Navigation.PushAsync(new CantinaInformation(Convert.ToInt32(customPin.Id)));
            }        
        }
